...
for iDataSet in range(nDataSet):
    ...
    for epoch in range(1, epochs + 1):
        ...
        for i in range(1, num_iter):
            ...
            loss = cls_loss + 0.3 * lambd * lmmd_loss + contrastive_loss_t + contrastive_loss_s
...
# 如果需要保存分类结果图，请取消注释
# utils.classification_map(hsi_pic[4:-4, 4:-4, :], best_G[4:-4, 4:-4], 24,  "classificationMap/Pavia/pavia_result.png")
...
plt.title('Training Metrics (UP2PC): Loss, OA & AA')
plt.grid(True, which='both', linestyle='--', linewidth=0.5)
plt.tight_layout()

save_path = 'classificationMap/Pavia/combined_metrics_curve.png'
